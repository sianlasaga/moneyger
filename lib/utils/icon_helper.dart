...
IconData getIconByString(iconName) {
  IconData selectedIcon = IconsMap[iconName];
...
List<IconData> getAccountIcons() {
  return accountIconNames.map((iconName) => getIconByString(iconName)).toList();
}

List<IconData> getCategoryIcons() {
  return categoryIconNames
      .map((iconName) => getIconByString(iconName))
      .toList();
}

List<String> accountIconNames = [
